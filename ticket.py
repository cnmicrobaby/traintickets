...
def getTrainTickets(from_station, to_station, date):
    ...
    train_tickets = json.loads(response.text).get('data').get('result')
...
if __name__ == '__main__':
    ...
    traintickets = getTrainTickets(fromStation, toStation, tripDate)
    trainlist = TrainsCollection(traintickets)
